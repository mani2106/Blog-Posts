...
"""
    ...
    def test_configuration_loading_and_validation(self):
        ...
        with patch.dict(os.environ, {'OPENROUTER_API_KEY': 'test_key'}):
            ...
            assert config.creative_model == 'anthropic/claude-3-sonnet'
        ...
        with patch.dict(os.environ, {
            ...
            assert config.creative_model == 'anthropic/claude-3-sonnet'  # From YAML
            ...
            with patch('src.ai_orchestrator.httpx.post') as mock_post:
                ...
                with patch('src.output_manager.Github') as mock_github:
                    ...
                    orchestrator = AIOrchestrator(
                        api_key='test_key',
                        planning_model='anthropic/claude-3-haiku'
                    )
